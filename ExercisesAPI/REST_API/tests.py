...
class ExerciseViewTest(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.exercise = Exercise.objects.create(
            name="Palindrome", language=self.language
        )
        self.test1 = ExerciseTest.objects.create(
            exercise=self.exercise, input="kajak", output=True
        )
        self.test2 = ExerciseTest.objects.create(
            exercise=self.exercise, input="anna", output=True
        )
        self.test3 = ExerciseTest.objects.create(
            exercise=self.exercise, input="lajkonik", output=True
        )
