...
const API = {
    table: '/system/api/all-meetings/',
    allPaths: '/system/api/all-paths/',
    allStudents: '/system/api/all-students/',
    allYears: '/system/api/meeting-dates/',
    allMonths: '/system/api/meeting-dates/?year=',
    meetingDates: '/system/api/meeting-dates/'
};

if (IS_MODERATOR) {
    console.log('dupa');
    SELECTORS.mentorsList = document.getElementById('mentors');
    API.allMentors = '/system/api/all-mentors/';
}
