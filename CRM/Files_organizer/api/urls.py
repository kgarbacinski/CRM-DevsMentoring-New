...
urlpatterns = [
    ...
    path(
        "access/subject/<int:pk>/",
        HasAccessToSubjectView.as_view(),
        name="subject_access",
    ),
    path(
        "access/searchbox/subtopic/<int:pk>/",
        UserSearchBoxSubtopicView.as_view(),
        name="subtopic_searchbox",
    ),
    path(
        "access/searchbox/subject/<int:pk>/",
        UserSearchBoxSubjectView.as_view(),
