...
class PaymentForm(forms.ModelForm):
    ...
    companyName = forms.CharField(required=None, widget=forms.TextInput(attrs={'id': 'company'}),
                                  label='company')
    nip = forms.CharField(required=None, max_length=10, widget=forms.TextInput(attrs={'id': 'company-nip'}),
                          label='company-nip')
